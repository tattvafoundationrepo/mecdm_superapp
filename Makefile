...
playground:
	...
	@echo "|                                                                             |"
	@echo "| 🔍 IMPORTANT: Select the 'data_science' folder to interact with your agent.          |"
	@echo "==============================================================================="
...
local-backend:
	uv run uvicorn data_science.fast_api_app:app --host localhost --port $(or $(PORT),8000) --reload
...
deploy:
	...
	gcloud beta run deploy mecdm-super-agent \
		--source . \
		--memory "4Gi" \
		--project $$PROJECT_ID \
		--region "global" \
...
eval:
	...
	uv run adk eval ./data_science $${EVALSET:-tests/eval/evalsets/basic.evalset.json} \
